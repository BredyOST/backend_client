...
import {LogsServiceAddNannies, LogsServiceAddTutors} from "../../otherServices/loggerService/logger.service";
import {RedisService} from "../../redis/redis.service";


@Injectable()
export class NanniesService implements CategoryStrategy{
  ...
  constructor(
      ...
      private logsServiceAddNannies: LogsServiceAddNannies,
  ...
  async getAll() {
      const posts = await this.redisService.get('53b709ebbcf6dce10f315dfa2d95402faae7a01b8cc2f2ec792bfd038752b233')
      if (posts && posts !== null) {
  ...
  async sendPostToTelegram(item, tokenBot, telegramLimiter) {
    ...
    try {
      ...
      this.logsServiceAddNannies.error(`Функция проверки и получению постов с вк - ошибка`, `${err}`,)
    }
  }
    ...
    const {data} = await firstValueFrom(
        this.httpService.post<any>(
            ...
            catchError((error: AxiosError) => {
              ...
              this.logsServiceAddNannies.error(`Функция проверки и получению постов с вк - ошибка`, `${error}`,)
